...
#fig_age_points.savefig("./results/3const_Bend_%ddeg.pdf"%deg,dpi=200,bbox_inches="tight")
...
fig_dis.savefig("./results/3const_Bend_IHSD_%ddeg.png"%deg,dpi=200,bbox_inches="tight")
fig_dis.savefig("./results/3const_Bend_IHSD_%ddeg.pdf"%deg,dpi=200,bbox_inches="tight")
fig_div.savefig("./results/3const_Bend_IHSR_%ddeg.pdf"%deg,dpi=200,bbox_inches="tight")
